...
//  if (!__quiet && !this.quiet)
    ...
    let info = parseCallStack(e.stack.toString());
    logTrace(this.module, "WARNNING", info, msg, this.custom_handler);
};
...
WebRTC.prototype.open = function(media_avail_handler, media_not_avail_handler, ice_complete_handler) {
  ...
  getUserMedia(mm,
    function(stream) {
      ...
      //!!!
      //stream = document.getElementById("pre-set-audio").captureStream();
  ...
  // if (document.getElementById("pre-set-audio") != null) {
  //   var stream = document.getElementById("pre-set-audio").captureStream();
  //
  //   var local_media = document.getElementById(self.local_media_dom_id);
  //   self.attachMediaStream(local_media, stream);
  //   self.localStream = stream;
  ...
  this.peerConnection.oniceconnectionstatechange = function(e) {
    ...
    if (this.iceConnectionState == "connected") {
      //console.log("Starting media in 5 seconds...");
      //setTimeout(function() {
      //  document.getElementById("pre-set-audio").play();
      //}, 5000);
    } else if (this.iceConnectionState == "closed") {
      //setTimeout(function() {
      //document.getElementById("pre-set-audio").pause();
      //}, 5000);
    }
  };
  /*
...
WebRTC.prototype.localRefreshCall = function(ice_complete_handler) {
  ...
  this.peerConnection.createOffer(
    ...
    function(e) {console.log("createOffer failed"); console.log(e);},       // failed
